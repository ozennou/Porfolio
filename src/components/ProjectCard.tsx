                    ...
                    <div className='flex flex-wrap 2xl:flex-nowrap justify-self-stretch my-6 ml-5 overflow-hidden'>
                        {stacks.map((stack, index) => (
                            <div key={index} className='bg-[#191919] rounded-2xl mx-2 my-1'>
                                <p className='py-2 px-4 text-xs font-light '>{stack}</p>
                            </div>
                        ))}
                    </div>
                </div>
                <div className='flex flex-col w-full'>
                    <div className='mx-6 mb-2 xl:mt-6 flex-grow'>
                    ...
                    </div>
                    {
                        ...
                        <div className='flex flex-col items-end'>
                            <a 
                                className='flex justify-center items-center pb-8 pr-6 cursor-pointer z-20 hover:opacity-80 transition-opacity duration-200' 
                                target="_blank" 
            ...
            <div className='flex flex-col w-full'>
                ...
                </div>
                {
                    ...
                    <div className='flex flex-col items-start'>
                        <a 
                            className='flex justify-center items-center pb-8 pl-6 cursor-pointer z-20 hover:opacity-80 transition-opacity duration-200' 
                            target="_blank" 
                            rel="noopener noreferrer"
                            href={gh_link}
                        >
